(function () {
    ...
    */
    ...
    registerRoute( // Check to see if the request is a navigation to a new page
    ({
      request
    ...
    registerRoute( // Check to see if the request's destination is style for stylesheets, script for JavaScript, or worker for web worker
    ({
      request
    ...
    registerRoute( // Check to see if the request's destination is style for an image
    ({
      request
